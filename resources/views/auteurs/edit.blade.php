...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="page-title">
                        <h1>Modifier Auteur: {{ $auteur->nomComplet  }}</h1>
                    </div>
                </div>
                <div class="col-sm-6">
    ...
    <section class="small_pb">
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.01s">
                        <div class="heading_s1 text-center">
                            <h2>Modification de l'Auteur <strong>{{ $auteur->nomComplet }}</strong></h2>
                        </div>
                        <p></p>
            ...
            <div class="row">
                <div class="col-12">
                    <auteur-create auteur_prop="{{ json_encode($auteur) }}"></auteur-create>
                </div>
            </div>
        </div>
    </section>
